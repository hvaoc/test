...
const styles = StyleSheet.create({
  ...
  cellDim: { backgroundColor: colors.surfaceMuted },
  ...
  chipWrap: { width: '100%' },
  chip: { flexDirection: 'row', alignItems: 'center', gap: 4, backgroundColor: colors.surfaceMuted, borderRadius: 4, paddingHorizontal: 4, paddingVertical: 1 },
  ...
  panel: { width: PANEL_W, backgroundColor: colors.surfaceMuted, borderLeftWidth: StyleSheet.hairlineWidth, borderLeftColor: colors.separator, paddingHorizontal: spacing.md, paddingTop: spacing.sm, marginRight: -spacing.lg },
  panelScroll: { flex: 1 },
